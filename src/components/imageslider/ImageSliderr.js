...
const ImageSliderr = () => {
  ...
  const handleClose = () => {
    ...
    setTimeout(() => {
      ...
      setIsClosing(false);
    }, 500); // زمان انیمیشن را با مدت زمان انیمیشن در CSS هماهنگ کنید | Sync animation timing with CSS duration
  ...
  return (
    <div id='sliderr'>
      ...
      <p className="container centered pb-3">
        یاقوت کبود به عنوان نماد حکمت و عقل شناخته می‌شود. طراحی‌های ما با استفاده از این سنگ با ارزش، جواهری را به شما هدیه می‌دهد که زیبایی و اصالت را به نمایش می‌گذارد.
        <br />
        مرواریدها نماد خلوص و پاکی هستند. در این مجموعه، جواهراتی را خواهید دید که با ترکیب مرواریدهای درخشان و طراحی‌های بی‌نظیر، شکوه و جلال را به شما ارائه می‌دهند.
        <br />
        زمرد، با رنگ سبز زیبای خود، نماد عشق و وفاداری است. این مجموعه جواهرات شما را به دنیایی از عشق و زندگی می‌برد.
        <br />
        یاقوت سرخ به عنوان نماد عشق و اشتیاق طراحی شده است. جواهرات این مجموعه با رنگ‌های گرم و زنده، حس قدرت و انرژی را به شما القا می‌کند.
        <br />
        برلیان‌ها به دلیل درخشندگی و دوام بالا، نمادی از جاودانگی و تعهد هستند. این مجموعه با طراحی‌های چشم‌نواز و استفاده از برلیان‌های با کیفیت، برای لحظات خاص شما ساخته شده است.
      </p>
